"""
Django settings for BookWings project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'cart.context_processor.cart_custom_processor',
            ],
        },
    },
]

WSGI_APPLICATION = 'BookWings.wsgi.application'
